...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        '../app/features/product/product-list/product-list.component'
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        '../app/features/product/product-search/product-search.component'
      ).then((m) => m.ProductSearchComponent),
  },
  {
    path: 'product/add',
    loadComponent: () =>
      import('../app/features/product/product-add/product-add.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        '../app/features/product/product-item/product-item.component'
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        '../app/features/product/product-category/product-category.component'
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        '../app/features/product/product-subcategory/product-subcategory.component'
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        '../app/features/product/product-update/product-update.component'
      ).then((m) => m.ProductUpdateComponent),
  },
  {
    path: 'cart',
    loadComponent: () =>
      import('../app/features/cart/cart.component').then(
        (m) => m.CartComponent
      ),
  },
  {
